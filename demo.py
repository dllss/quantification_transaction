...
ts.set_token(mytoken)
save_path = 'E:\Project\quantification_transaction'
pro = ts.pro_api()
...
def getNoramlData():
    ...
    pool.to_csv(os.path.join(save_path, 'company_info.csv'),
                index=False,
                encoding='ANSI')
...
def getIndexData():
    ...
    df.to_csv(os.path.join(save_path, 'SZSE.csv'),
              index=False,
              encoding='ANSI')
    ...
    index = [
        '000001.SH', '000016.SH', '000002.SH', '399001.SZ', '399007.SZ',
